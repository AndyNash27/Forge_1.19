package net.AndyNash.tutorialmod.event;

import joptsimple.internal.Messages;
import net.AndyNash.tutorialmod.TutorialMod;
import net.AndyNash.tutorialmod.networking.ModMessages;
import net.AndyNash.tutorialmod.networking.packet.DrinkWaterC2SPacket;
import net.AndyNash.tutorialmod.networking.packet.ExampleC2SPacket;
import net.AndyNash.tutorialmod.util.KeyBinding;
